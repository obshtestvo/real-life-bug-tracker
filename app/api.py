...
# ref: pythonhosted.org/Flask-OAuth/#facebook-oauth
...
class Login(restful.Resource):
    ...
    def get(self):
        # ref: pythonhosted.org/Flask-OAuth/#signing-in-authorizing
...
class Auth(restful.Resource):
    ...
    def get(self, resp):
        ...
        # @todo if user doesnt exist - create one
        # @todo retrieve data for user by email
...
api.add_resource(Auth, '/login/auth', endpoint='auth')
